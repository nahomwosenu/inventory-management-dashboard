...
```bash
git remote add encore encore://inventory-management-dashboard-psfi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/inventory-management-dashboard-psfi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/inventory-management-dashboard-psfi/settings/integrations/github)
